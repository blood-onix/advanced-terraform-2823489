...
# S3 BUCKET
# //////////////////////////////
resource "aws_s3_bucket" "bloodterra-tfstate" {
...
resource "aws_s3_bucket_public_access_block" "bloodterra-tfstate" {
  bucket = aws_s3_bucket.bloodterra-tfstate.id
